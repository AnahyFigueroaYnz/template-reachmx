...
(function (e) {
    ...
    e.extend(t.prototype, {
        ...
        _popover: function (a, b, c) {
            var d = this.c,
                f = e.extend({ align: "button-left", autoClose: !1, background: !0, backgroundClassName: "dt-button-background", contentClassName: d.dom.collection.className, collectionLayout: "", collectionTitle: "", dropup: !1, fade: 400, rightAlignClassName: "dt-button-right", tag: d.dom.collection.tag }, c),
                h = b.node(),
                m = function () {
    ...
    t.buttonSelector = function (a, b) {
        for (
            var c = [],
                d = function (g, n, k) {
                    for (var p, l, v = 0, u = n.length; v < u; v++) if ((p = n[v])) (l = k !== r ? k + v : v + ""), g.push({ node: p.node, name: p.conf.name, idx: l }), p.buttons && d(g, p.buttons, l + "-");
                },
                f = function (g, n) {
                    var k,
                        p = [];
                    ...
                    if (Array.isArray(g) || g instanceof e) for (l = 0, k = g.length; l < k; l++) f(g[l], n);
                        ...
                        else if (-1 !== g.indexOf(":name")) for (g = g.replace(":name", ""), l = 0, k = p.length; l < k; l++) p[l].name === g && c.push({ inst: n, node: p[l].node });
                        else
                            e(l)
                                .filter(g)
                                .each(function () {
    ...
    t.defaults = { buttons: ["copy", "excel", "csv", "pdf", "print"], name: "main", tabIndex: 0, dom: { container: { tag: "div", className: "dt-buttons" }, collection: { tag: "div", className: "" }, button: { tag: "button", className: "dt-button", active: "active", disabled: "disabled" }, buttonLiner: { tag: "span", className: "" } } };
    t.version = "1.7.1";
    e.extend(x, {
        collection: {
            text: function (a) {
