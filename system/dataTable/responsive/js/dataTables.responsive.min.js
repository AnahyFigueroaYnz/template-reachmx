...
$jscomp.polyfillIsolated = function (b, k, m, n) {
    ...
    k = k(m);
    null != k && (b ? $jscomp.defineProperty($jscomp.polyfills, p, { configurable: !0, writable: !0, value: k }) : k !== m && (($jscomp.propertyToPolyfillSymbol[p] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(p) : $jscomp.POLYFILL_PREFIX + p), (p = $jscomp.propertyToPolyfillSymbol[p]), $jscomp.defineProperty(n, p, { configurable: !0, writable: !0, value: k })));
};
$jscomp.polyfill(
...
(function (b) {
    ...
    var z = b.fn.dataTable,
        u = function (a, c) {
            ...
            this.s.dt.settings()[0].responsive || (c && "string" === typeof c.details ? (c.details = { type: c.details }) : c && !1 === c.details ? (c.details = { type: !1 }) : c && !0 === c.details && (c.details = { type: "inline" }), (this.c = b.extend(!0, {}, u.defaults, z.defaults.responsive, c)), (a.responsive = this), this._constructor());
        };
    b.extend(u.prototype, {
        ...
        _detailsObj: function (a) {
            ...
            return b.map(this.s.columns, function (f, g) {
                if (!f.never && !f.control) return (f = d.settings()[0].aoColumns[g]), { className: f.sClass, columnIndex: g, data: d.cell(a, g).render(c.c.orthogonal), hidden: d.column(g).visible() && !c.s.current[g], rowIndex: a, title: null !== f.sTitle ? f.sTitle : b(d.column(g).header()).text() };
            });
        },
        _find: function (a) {
